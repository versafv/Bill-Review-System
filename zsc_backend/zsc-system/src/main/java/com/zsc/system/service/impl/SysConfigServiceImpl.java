...
import com.zsc.system.mapper.SysConfigMapper;
...
public class SysConfigServiceImpl implements ISysConfigService
{
     ...
     */
    @Override
    public List<SysConfig> selectConfigList(Page<SysConfig> page, SysConfig config)
    {
    ...
    {
        List<SysConfig> configsList = configMapper.selectConfigList(new Page<SysConfig>(), new SysConfig());
